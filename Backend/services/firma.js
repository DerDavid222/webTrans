...
serviceRouter.post('/firma', function(request, response) {
    ...
    const firmaDao = new FirmaDao(request.app.locals.dbConnection);
    try {
        var obj = firmaDao.create(request.body.name, request.body.inhaber, request.body.beschreibung, request.body.adresse.id, request.body.ansprechpartner);
...
serviceRouter.put('/firma', function(request, response) {
    ...
    const firmaDao = new FirmaDao(request.app.locals.dbConnection);
    try {
        var obj = firmaDao.update(request.body.id, request.body.name, request.body.inhaber, request.body.beschreibung, request.body.adresse.id, request.body.ansprechpartner);
